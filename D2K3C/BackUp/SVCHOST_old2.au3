...
Local $debugmode = 1 ;   1 打开 0 关闭 手动调试模式，用于游戏内控制
...
Func runGame()
	...
	Select
		...
		Case $debugmode = 1
			...
			Sleep(10)
			TrayTip("", "子进程id: " & $PidChild1  & @CR & "不加血：" & $childmsg[0] & @CR & "不加法力：" & $childmsg[1] & @CR & "不加雇佣兵血：" & $childmsg[2] & @CR & "有血瓶：" & $childmsg[3] & @CR & "有蓝瓶：" & $childmsg[4] & @CR & "有紫瓶：" & $childmsg[5] & @CR & "无人进房间：" & $childmsg[6] & @CR & "无人m你：" & $childmsg[7] & @CR  & "test:" & $childmsg[8] , 1, 16)
			Sleep(2000)
