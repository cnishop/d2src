	...
	Select
		...
		Case Else
			If isInRoom() Then
				...
				MouseClick("left", 700, 320, Random(1, 3, 1))
				Sleep(300)
				CheckMove($Char_CheckMoveDelay)
				
				$coord = PixelSearch(450, 100, 700, 400, $a3colorBlock, 10, 1, $title)
				If @error Then
						MouseClick("left",  $coord[0] + 100, $coord[1] + 150, Random(1, 5, 1))
						Sleep(500)
					Else
						MouseClick("left", 700, 290, Random(1, 3, 1))
				EndIf
				...
				$begin1 = TimerInit()
				Do
					$coord = PixelSearch(400, 50, 750, 400, $a3colorBlock, 10, 1, $title)
					If @error Then
						MouseClick("left", 760 + $xrd, 100 + $yrd, Random(1, 5, 1))
						Sleep(50)
						$findflag = 0
					Else
...
Func a3omousToWp()
	...
	Select
		...
		Case Else
			...
			CheckMove($Char_CheckMoveDelay)
			$coord = PixelSearch(400, 200, 790, 520, $a3colorBlock, 10, 1, $title)
			If Not @error Then
