...
#AutoIt3Wrapper_Res_Comment=暗黑K3C精灵,非BOT，服务器端无法检测到，安全
#AutoIt3Wrapper_Res_Description=暗黑k3C挂机王，挂机专用
...
$bindmac = 1 ;绑定机器
$bindacc = 0 ;绑定帐号
$bindlimitCount = 1 ;  绑定次数
$bindTime = 0 ;数据库中的次数  ;只测试版用到

$limitRound = 80 ;持续挂机次数
...
Func tradeomous();前提是在已经点钟omous的情况下
