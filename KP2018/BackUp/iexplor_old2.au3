...
$acountArray[0] = "shuishui1055"
$acountArray[1] = "shuishui1055"

Global $bindmac = 1;绑定机器
Global $bindacc = 0;绑定帐号

Local $killQuery = 1 ;设定一个打怪队列，比如  1 kp， 2杀督军山克上面的怪， 3 杀督军山克
...
;~
					...
					Case 2 ;杀督军山克上面的怪
						...
						CheckMove($Char_CheckMoveDelay)
						MouseClick("left", 170 + Random(1, 10), 520 + Random(1, 10), 1)
						CheckMove($Char_CheckMoveDelay)
