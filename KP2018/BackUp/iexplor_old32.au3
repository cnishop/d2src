...
;### Tidy Error -> "endif" is closing previous "case" on line 737
					
;### Tidy Error -> "endif" is closing previous "switch" on line 736
				EndIf
				If $onlykp <> 1 Then
					ContinueCase
				EndIf
...
;~ 							EndIf
					...
					If isInRoom() Then ;TP 到怪物面前
						...
						$begin1 = TimerInit()
						Do
							$coord = PixelSearch(50, 30, 780, 280, $MonsterRed, 10, 1, $title)
							If @error Then
...
;### Tidy Error -> "endswitch" is closing previous "select" on line 628
		EndSwitch
;### Tidy Error -> "endselect" is closing previous "func" on line 608
EndSelect
