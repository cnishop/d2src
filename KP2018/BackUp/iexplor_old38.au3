...
;~ 							EndIf
					...
					Case 3 ;杀山克
						...
						If $topleft = True And $bottomright = True Then ;;上下都有标记位，到达指定地点，可以杀怪
							...
							EndIf
							$coord = PixelSearch(500, 300, 780, 540, $biaojicolor1, 10, 1, $title)
							If Not @error Then
								$bottomright = True
								TrayTip("", "楼梯上2", 1, 16)
							...
							EndIf
							$coord = PixelSearch(410, 300, 750, 540, $biaojicolor1, 10, 1, $title)
							If Not @error Then
								$bottomright = True
								TrayTip("", "楼梯上3", 1, 16)
								;TrayTip("", $coord[0] & "  " & $coord[1], 1, 16)
							...
							EndIf
							$coord = PixelSearch(500, 300, 780, 540, $biaojicolor1, 10, 1, $title) ;达到楼梯下方的打怪点，可以打怪
							If Not @error Then
								$bottomright = True
								TrayTip("", "楼梯下1", 1, 16)
								;TrayTip("", $coord[0] & "  " & $coord[1], 1, 16)
							...
							EndIf
							$coord = PixelSearch(420, 200, 600, 500, $biaojicolor1, 10, 1, $title) ;到达中间打怪点
							If Not @error Then
								$bottomright = True
								;TrayTip("", $coord[0] & "  " & $coord[1], 1, 16)
								TrayTip("", "out", 1, 16)
