...
;~
					...
					Case 3 ;杀山克
						...
						EndSwitch
;### Tidy Error -> "endselect" is closing previous "switch" on line 680
				EndSelect
;### Tidy Error -> "endif" is closing previous "case" on line 610
			EndIf
;### Tidy Error -> "endfunc" is closing previous "select" on line 609
		EndFunc   ;==>roomplay
