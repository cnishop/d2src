...
$RegGUI = GUICreate("【注册QQ：123】", 283, 157, @DesktopWidth/2-150,@DesktopHeight/2-150)
$Title = GUICtrlCreateLabel(" 程序注册机 ", 80, 4, 130, 20)
GUICtrlSetFont(-1, 10, 800, 0, "【注册QQ：123】")
...
Func _CdKey() ;加密的关键部分 这里是用MD5加密  整个注册机的关键部分就是这里, 如果要自己写加密算法 那就复杂了
	$Cdkey = StringMid(_MD5( GUICtrlRead($RegUser) & $KeyPw), 3, 34) ;MD5加密 没事可以试着破解一下@!!!!!
